...
- [ ] **GitHub Epic created**: Epic issue created via `/github-issue-create.md` workflow with WHY context and scope
- [ ] **Manifest updated**: `.holicode/specs/WORK_SPEC.md` updated with GitHub issue link
...
3) **Ask for user confirmation before creating GitHub Epic:**
   ...
   <ask_followup_question>
   <question>Based on the business context, I recommend creating a GitHub Epic for [X]. This will establish [Y scope] with [Z success metrics]. Shall I proceed with creating the Epic?</question>
...
5) **Create GitHub Epic via `/github-issue-create.md` workflow**:
   - ticket_type: "epic"
   - ticket_title: "EPIC: [Feature Name]"
   - ticket_description: [Use Epic template, include business value, success metrics, scope]
   - ticket_labels: ["epic", "feature"]
6) Update `.holicode/specs/WORK_SPEC.md` manifest with GitHub Epic issue link
...
- GitHub Epic issue (primary deliverable)
- .holicode/specs/WORK_SPEC.md (updated with GitHub Epic link)
...
- ticket_type: "epic"
- ticket_title: "EPIC: [Feature Name]"
- ticket_description: [Use Epic template from .holicode/templates/github/]
- ticket_labels: ["epic", "feature"]
...
Use template from `.holicode/templates/github/epic-template.md` when creating the GitHub Epic issue.
