...
- [ ] GitHub Story issue exists with complete EARS story
- [ ] Story issue contains acceptance criteria and component references
- [ ] WORK_SPEC.md manifest contains link to the GitHub story
- [ ] Pre-flight validation checks passed

## Definition of Done (DoD)
- [ ] **GitHub Tasks created**: Task issues created via `/github-issue-create.md` workflow with 2-3 XS/S tasks
...
- [ ] WORK_SPEC.md manifest updated with GitHub task issue links
...
2) **Read relevant Story issue from GitHub** via MCP tools (`get_issue`)
...
4) **Create GitHub Tasks via `/github-issue-create.md` workflow**:
   - For each task:
     - ticket_type: "task"
     - ticket_title: "TASK-{id}: {description}"
     - ticket_description: Use Task template with metadata, acceptance criteria, component references
     - ticket_labels: ["task", "size-{XS/S/M}", "story-{id}", "type-{architectural/functional}"]
...
5) **Update `.holicode/specs/WORK_SPEC.md` manifest** with GitHub task issue links
...
- GitHub Task issues (primary deliverable)
- Component SPECs: `src/{component}/SPEC.md` (local technical contracts)
- .holicode/specs/WORK_SPEC.md (updated with GitHub task links)
...
- ticket_type: "task"
- ticket_title: "TASK-{id}: {description}"
- ticket_description: [Use Task template from .holicode/templates/github/]
- ticket_labels: ["task", "size-{XS/S/M}", "story-{id}", "type-{architectural/functional}"]
