...
- [ ] **GitHub TD Issues created**: Summary issues created via `/github-issue-create.md` for each TD
...
- [ ] WORK_SPEC.md updated with GitHub TD issue links and local TD paths
...
3) **Generate Architectural TD Documents**:
   ...
   - **Create GitHub TD Issues via `/github-issue-create.md` workflow**:
     - For each TD, create summary issue:
       - ticket_type: "technical-design"
       - ticket_title: "TD-{number}: {title}"
       - ticket_description: [Executive summary and key decisions]
       - ticket_labels: ["technical-design", "TD-{number}", "architecture"]
     - Keep detailed TD in `.holicode/specs/technical-design/TD-{number}.md`
     - Link bidirectionally (GitHub issue ↔ local TD file)
...
## Output Files
- GitHub TD Issues (created via `/github-issue-create.md`)
...
- `.holicode/specs/WORK_SPEC.md` (updated with GitHub issue links and local TD paths)
...
- ticket_type: "technical-design"
- ticket_title: "TD-{number}: {title}"
- ticket_description: [Use TD template from .holicode/templates/github/]
- ticket_labels: ["technical-design", "TD-{number}", "architecture"]

**Alternative (Offline)**: Write specification to `.holicode/specs/technical-design/TD-{number}.md` instead
