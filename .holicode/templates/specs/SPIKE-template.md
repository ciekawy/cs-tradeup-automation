...
<!-- NOTE: This is a LOCAL REFERENCE template. 
     Primary SPIKE tracking happens in GitHub Issues.
     Use this template only when creating local investigation details. -->

**GitHub Issue:** [#xxx - Link to GitHub SPIKE issue]  
**Related Task:** [#yyy - Link to blocked GitHub task issue]  
...
---
*Primary SPIKE tracking happens in GitHub Issues. This template is for local investigation details only.*
*Run `/github-sync.md` to sync GitHub state to local cache.*
